...
def f_predict_function(u):
    molecular = (-3.745535277318256)*u**2+(2.947571236807219)*u+(-1.4715481065160123)*1+(-0.15249133112969723)*u**4+(-0.016438784051764518)*u**5+(0.010973610243924431)*u**3+(-0.0005588432694777721)*u**6+(-6.94976642062786e-06)*u**7
    denominator = (0.7531104082685331)*u**2+(-0.44265756183682126)*u+(0.2848740560037533)*1+(-0.2529949741983936)*u**3+(0.21710712338531102)*u**4+(0.02361447029997827)*u**5+(0.0008027836942118037)*u**6+(9.983405841631395e-06)*u**7
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_6_dt_0.1_layer_10_beta_200'
