...
if __name__ == "__main__":
    ...
    # 引入模型
    net = Net(18, 1)  # power_nb = 8
    # net = Net(16, 1)  # power_nb = 7
    # net = Net(14, 1) # power_nb = 6
    # net = Net(12, 1)  # power_nb = 5
    # net = Net(10, 1)  # power_nb = 4
    # net = Net(8, 1)  # power_nb = 3
    # net = Net(6, 1)  # power_nb = 2
    # net = Net(4, 1)  # power_nb = 1
    print(net)
    epoch = 100001
    ...
    print("\033[33mstarttime %.6f, endtime %.6f, deltatime %.6f, \033[0m" % (start_time, end_time, delta_time))