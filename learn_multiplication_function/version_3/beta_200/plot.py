...
def f_predict_function(u):
    ...
    molecular = 3.2918*u + 0.7568*u**2 + (-0.3651)*u**3 + (0.1185)*u**4 + (-0.0732)*u**5 + (1.6405) *u**6 + (0.8498)*u**7 + (0.6175)
    denominator = (-0.9394)*u + 1.6595*u**2 + 1.3224*u**3 + 0.4577*u**4 + 0.7645*u**5 + 0.5628 *u**6 + (-0.5101)*u**7 + (1.3740)
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_6_dt_0.1_layer_10_beta_200_poly_1'
