...
def f_predict_function(u):
    molecular = (-1.169527220162542)*1+(1.0148550947133124)*u+(-0.6819520490070117)*u**2+(-0.01588645735416282)*u**3+(-0.010348827822387816)*u**4+(-0.001068230043660294)*u**5+(-2.1542974424499495e-05)*u**6
    denominator = (0.6221331980333104)*1+(0.5092868806999505)*u+(-0.1649175981665886)*u**2+(-0.0054877855318505656)*u**4+(0.000735974826791462)*u**3+(-0.0005633318693410192)*u**5+(-1.1360702805301709e-05)*u**6
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_6_dt_0.1_layer_10_beta_100_2'
