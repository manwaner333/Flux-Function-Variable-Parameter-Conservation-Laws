...
def f_predict_function(u):
    c = [-0.5817, -0.3470, -0.0248,  0.2526,  0.4716,  0.2162,  0.5446,  0.4961,
          0.4238,  0.4369, -0.1033]
    if -0.1 < u <= 0:
        res = c[0] * psi_0_l(u)
    elif 0 < u <= 0.1:
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_6_dt_0.1_layer_10_beta_200_diehl'
    ...
    # 画出观测数据得分布图
    # time_point_list = [0, 18, 35, 53, 71, 88, 106, 124, 142, 159]
