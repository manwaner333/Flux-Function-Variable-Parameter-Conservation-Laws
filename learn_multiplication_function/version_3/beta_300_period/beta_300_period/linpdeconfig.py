...
def loss(model, stepnum, obs_data, layerweight=None):
    ...
    # v_1_d = outputs_deno
    # v_2_d = outputs_deno * outputs_deno
    # v_3_d = outputs_deno * outputs_deno * outputs_deno
    # v_4_d = outputs_deno * outputs_deno * outputs_deno * outputs_deno
    # v_5_d = outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno
    # v_6_d = outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno
    # v_7_d = outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno
    # # v_8_d = outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno * outputs_deno
    # outputs_d = torch.cat([v_1_d, v_2_d, v_3_d, v_4_d, v_5_d, v_6_d, v_7_d], dim=-1)
    #
    # deno = model.poly0.denominator(outputs_d)
    ...
    print("\033[33mloss0 %.6f, data loss0 %.6f, max_f_prime_loss0 %.6f, stable loss %.6f, sparse loss %.6f, max_f_prime %.6f, \033[0m" % (loss, dataloss, max_f_prime_loss, 0.05*stableloss, 0.005*sparseloss, max_f_prime)) # 黄色
