...
def f_predict_function(u):
    # molecular = (-4.4256220007778)*u**2+(4.244529007110023)*u+(-1.4963208973122593)*1+(0.8044608008167194)*u**4+(0.11429683396864096)*u**6+(-0.07900901694708123)*u**3+(-0.07845751263115316)*u**5+(-0.011784552228995434)*u**8+(0.007316912675807139)*u**7
    # denominator = (0.7998309037619399)*1+(-0.47563628238708905)*u**3+(0.42626012642431754)*u**4+(0.4054660276615016)*u**2+(-0.22982689817881083)*u**6+(-0.16450665122170496)*u+(0.15776155944783263)*u**5+(0.023696256415635306)*u**8+(-0.014712772752632466)*u**7
    molecular = 0.7146*u + 0.6873*u**2 + (-0.4096)*u**3 + (-0.1241)*u**4+ (-0.0529)*u**5 - 0.1592
    denominator = -0.4698*u + 1.4615*u**2 + 0.2345*u**3 + 0.7918*u**4+ 0.1672*u**5 + 0.2445
...
if __name__ == "__main__":
    ...
    test_data_name = 'N_400_example_9_dt_0.1_layer_10_beta_300_poly'
