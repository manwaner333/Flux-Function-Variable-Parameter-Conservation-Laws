...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        f = (torch.pow(u, 2) * (1 - (-3.0) * torch.pow(1-u, 4))) / (torch.pow(u, 2) + 0.5 * torch.pow(1-u, 4))
        return f
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    u_0_np[5:6, 100:180] = 0.7
    u_0_np[6:7, 100:180] = 0.6
...
if __name__ == "__main__":
    experiment_name = 'N_400_example_7_dt_0.1_layer_10_grav_ne_3'
