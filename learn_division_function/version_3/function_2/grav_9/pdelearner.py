...
class VariantCoeLinear1d(torch.nn.Module):
    ...
    def f_real(self, u):
        f = (torch.pow(u, 2) * (1 - 9 * torch.pow(1-u, 4))) / (torch.pow(u, 2) + 0.5 * torch.pow(1-u, 4))
        return f
...
def generate_real_data(save_file, u0_file, u_fixed_file):
    ...
    u_0_np[5:6, 100:180] = 0.9
    u_0_np[5:6, 0:100] = 0.3
    u_0_np[5:6, 180:400] = 0.3
    u_0_np[6:7, 100:180] = 0.8
    u_0_np[6:7, 0:100] = 0.3
    u_0_np[6:7, 180:400] = 0.3
    u_0_np[7:8, 80:160] = 0.7
    u_0_np[7:8, 0:80] = 0.3
    u_0_np[7:8, 160:400] = 0.3
...
if __name__ == "__main__":
    experiment_name = 'N_400_example_8_dt_0.1_layer_10_grav_9'
